        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="col-span-1 md:col-span-2 space-y-4">
            ...
            <p className="text-sm text-gray-500 max-w-md">
              Simplify your GitHub contributions invoicing process. Generate professional invoices from your GitHub activity with ease.
            </p>
          ...
          <div className="space-y-4">
            ...
            <nav className="flex flex-col space-y-2">
              <Link href="/legal" className="text-gray-500 hover:text-primary transition-colors">
                Contact Us
              </Link>
              <Link href="/blog/blog" className="text-gray-500 hover:text-primary transition-colors">
                Blog
              </Link>
